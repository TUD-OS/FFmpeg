...
#define LOG_LINE_LENGTH 512
    ...
    snprintf(line, LOG_LINE_LENGTH
             ...
             ", %d, %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32
             ...
             , ctx->tu_32_count, ctx->tu_16_count, ctx->tu_8_count, ctx->tu_4_count
...
void avpriv_init_log(const char* input_file)
{
    ...
    avpriv_log("frame_num, frame_time, slice_time, cabac_time, intra_cu_time, inter_cu_time, pcm_cu_time, transform_time, deblock_time, sao_time, metadata_time"
               ...
               ", tu_32_count, tu_16_count, tu_8_count, tu_4_count"

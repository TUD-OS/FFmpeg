...
#define LOG_LINE_LENGTH 512
    ...
    snprintf(line, LOG_LINE_LENGTH
             ...
             ", %d, %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32 ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32   ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32  ", %" PRIu32
             ...
             , ctx->inter_uni_count, ctx->inter_bi_count, ctx->inter_merge_mv_count, ctx->inter_regular_mv_count, ctx->inter_64_count, ctx->inter_32_count, ctx->inter_16_count, ctx->inter_8_count
...
void avpriv_init_log(const char* input_file)
{
    ...
    avpriv_log("frame_num, frame_time, slice_time, cabac_time, intra_cu_time, inter_cu_time, pcm_cu_time, transform_time, deblock_time, sao_time, metadata_time"
               ...
               ", inter_uni_count, inter_bi_count, inter_merge_mv_count, inter_regular_mv_count, inter_64_count, inter_32_count, inter_16_count, inter_8_count"
